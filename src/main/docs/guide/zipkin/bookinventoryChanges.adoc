...
Annotate `BooksController` method with `@ContinueSpan` and the method parameter with `@SpanTag`:

[source,java]
.bookinventory/src/main/java/example/micronaut/bookinventory/BooksController.groovy
----
